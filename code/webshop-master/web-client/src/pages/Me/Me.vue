<template>
  <div id="me">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <router-link class="navbar-brand col-sm-3 col-md-2 mr-0" to="/home">线上漫画交易平台</router-link>
            ...
            <el-menu
              ...
              <el-submenu index="3">
                ...
                <el-menu-item-group>
                  ...
                  <el-menu-item index="3-2" @click="goTo('/me/fagoods')">待发货</el-menu-item>
                  <el-menu-item index="3-3" @click="goTo('/me/getgoods')">待收货</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
            </el-menu>
          </div>

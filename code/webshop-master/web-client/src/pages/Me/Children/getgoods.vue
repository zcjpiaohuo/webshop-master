<template>
  <div id="getgoods">
    <div id="content">
			<div class="header">
				<img src="./../../../common/img/logo-round.jpg" class="header_logo" />
				<span>购物车</span>
			</div>
        ...
        <div class="zhuangtai">状态</div>
			...
			<div class="pro_box" v-if="cartgoods.length">
                ...
                <strong>{{content}}</strong>
						...
						<li class="td td-op"><a @click="queding()">确认收货</a></li>
					</ul>
				</div>
			</div>
     ...
     <el-dialog
      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click=" clickTrash">确 定</el-button>

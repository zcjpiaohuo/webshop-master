			...
			<el-row>
				...
				<el-col :span="4" :offset="1" class="cateList">
					...
					<el-menu
					  ...
					  text-color="#fff">
					  <el-menu-item   class="el-menu-item-vertical-demo" index="cate.cate_id" v-for="(cate) in categoryList" :key="cate.cate_id" @click="getRList(cate.cate_id)">

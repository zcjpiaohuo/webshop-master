<template>
  <div class="pro_item">
    <h4 class="item_title"><span>线上漫画交易平台</span><span class="item_one">{{goods.price  | moneyFormat}}</span></h4>
    <div class="item_content">
      ...
      <div class="item-sum"><strong>{{goods.buy_count * goods.price  | moneyFormat}}</strong></div>
    </div>
  </div>
</template>

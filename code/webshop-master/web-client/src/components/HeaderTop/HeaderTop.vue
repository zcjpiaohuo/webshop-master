<template>
        ...
        <div class="locationWrapper">
           <svg viewBox="0 0 32 32" class="icon iconLocation">
            ...
            <span class="address">{{selectedOptions[2] || city || '苏州市'}}</span>
        ...
        &nbsp;&nbsp;&nbsp;
				<li class="el-icon-user"><a @click.prevent="goMe">个人中心</a></li>&nbsp;&nbsp;
        <li class="el-icon-shopping-cart-2"><a @click.prevent="goShopCar">我的购物车</a></li>&nbsp;&nbsp;
				<li class="el-icon-place"><a @click.prevent="goAdmin">管理员通道</a></li>

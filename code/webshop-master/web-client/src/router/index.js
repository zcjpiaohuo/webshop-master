/*
 * @Author: your name
 * @Date: 2021-10-26 10:21:25
 * @LastEditTime: 2021-11-24 15:50:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \webshop-master\web-client\src\router\index.js
 */
// 1. 引入对应模块
import Vue from 'vue'
...
const getgoods = ()=> import('./../pages/Me/Children/getgoods');
const fagoods = ()=> import('./../pages/Me/Children/fagoods');
...
const deleteGoods = ()=> import('./../pages/Admin/Children/deleteGoods');
...
export default  new VueRouter({
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'fagoods', component: fagoods},
